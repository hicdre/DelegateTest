...
public:
	 ...
	 */
	template< class UserClass >
	inline static DELEGATE_CLASS CreateSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename TSPMethodDelegate< UserClass >::FMethodPtr InFunc )
	{
		return DELEGATE_CLASS( TSPMethodDelegate< UserClass >::Create( InUserObjectRef, InFunc ) );
	}
	template< class UserClass >
	inline static DELEGATE_CLASS CreateSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename TSPMethodDelegate_Const< UserClass >::FMethodPtr InFunc )
	{
		return DELEGATE_CLASS( TSPMethodDelegate_Const< UserClass >::Create( InUserObjectRef, InFunc ) );
	}
	template< class UserClass, PAYLOAD_TEMPLATE_DECL_OneVar >
	inline static DELEGATE_CLASS CreateSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename TSPMethodDelegate_OneVar< UserClass, PAYLOAD_TEMPLATE_LIST_OneVar >::FMethodPtr InFunc, PAYLOAD_TEMPLATE_ARGS_OneVar )
	{
	...
	template< class UserClass, PAYLOAD_TEMPLATE_DECL_OneVar >
	inline static DELEGATE_CLASS CreateSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename TSPMethodDelegate_OneVar_Const< UserClass, PAYLOAD_TEMPLATE_LIST_OneVar >::FMethodPtr InFunc, PAYLOAD_TEMPLATE_ARGS_OneVar )
	{
	...
	template< class UserClass, PAYLOAD_TEMPLATE_DECL_TwoVars >
	inline static DELEGATE_CLASS CreateSP( const std::shared_ptr< UserClass>& InUserObjectRef, typename TSPMethodDelegate_TwoVars< UserClass, PAYLOAD_TEMPLATE_LIST_TwoVars >::FMethodPtr InFunc, PAYLOAD_TEMPLATE_ARGS_TwoVars )
	{
	...
	template< class UserClass, PAYLOAD_TEMPLATE_DECL_TwoVars >
	inline static DELEGATE_CLASS CreateSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename TSPMethodDelegate_TwoVars_Const< UserClass, PAYLOAD_TEMPLATE_LIST_TwoVars >::FMethodPtr InFunc, PAYLOAD_TEMPLATE_ARGS_TwoVars )
	{
	...
	template< class UserClass, PAYLOAD_TEMPLATE_DECL_ThreeVars >
	inline static DELEGATE_CLASS CreateSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename TSPMethodDelegate_ThreeVars< UserClass, PAYLOAD_TEMPLATE_LIST_ThreeVars >::FMethodPtr InFunc, PAYLOAD_TEMPLATE_ARGS_ThreeVars )
	{
	...
	template< class UserClass, PAYLOAD_TEMPLATE_DECL_ThreeVars >
	inline static DELEGATE_CLASS CreateSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename TSPMethodDelegate_ThreeVars_Const< UserClass, PAYLOAD_TEMPLATE_LIST_ThreeVars >::FMethodPtr InFunc, PAYLOAD_TEMPLATE_ARGS_ThreeVars )
	{
	...
	template< class UserClass, PAYLOAD_TEMPLATE_DECL_FourVars >
	inline static DELEGATE_CLASS CreateSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename TSPMethodDelegate_FourVars< UserClass, PAYLOAD_TEMPLATE_LIST_FourVars >::FMethodPtr InFunc, PAYLOAD_TEMPLATE_ARGS_FourVars )
	{
	...
	template< class UserClass, PAYLOAD_TEMPLATE_DECL_FourVars >
	inline static DELEGATE_CLASS CreateSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename TSPMethodDelegate_FourVars_Const< UserClass, PAYLOAD_TEMPLATE_LIST_FourVars >::FMethodPtr InFunc, PAYLOAD_TEMPLATE_ARGS_FourVars )
	{
	...
	{
		return CreateSP( InUserObject->shared_from_this(), InFunc );
	}
	template< class UserClass >
	...
	{
		return CreateSP( InUserObject->shared_from_this(), InFunc, PAYLOAD_TEMPLATE_PASSIN_OneVar );
	}
	template< class UserClass, PAYLOAD_TEMPLATE_DECL_OneVar >
	...
	{
		return CreateSP( InUserObject->shared_from_this(), InFunc, PAYLOAD_TEMPLATE_PASSIN_TwoVars );
	}
	template< class UserClass, PAYLOAD_TEMPLATE_DECL_TwoVars >
	...
	{
		return CreateSP( InUserObject->shared_from_this(), InFunc, PAYLOAD_TEMPLATE_PASSIN_ThreeVars );
	}
	template< class UserClass, PAYLOAD_TEMPLATE_DECL_ThreeVars >
	...
	{
		return CreateSP( InUserObject->shared_from_this(), InFunc, PAYLOAD_TEMPLATE_PASSIN_FourVars );
	}
	template< class UserClass, PAYLOAD_TEMPLATE_DECL_FourVars >
...
public:
	...
	*/
	 ...
	 */
	template< class UserClass >
	inline void BindSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename TSPMethodDelegate< UserClass >::FMethodPtr InFunc )
	{
		*this = CreateSP( InUserObjectRef, InFunc );
	}
	template< class UserClass >
	inline void BindSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename TSPMethodDelegate_Const< UserClass >::FMethodPtr InFunc )
	{
		*this = CreateSP( InUserObjectRef, InFunc );
	}
	template< class UserClass, PAYLOAD_TEMPLATE_DECL_OneVar >
	inline void BindSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename TSPMethodDelegate_OneVar< UserClass, PAYLOAD_TEMPLATE_LIST_OneVar >::FMethodPtr InFunc, PAYLOAD_TEMPLATE_ARGS_OneVar )
	{
		*this = CreateSP( InUserObjectRef, InFunc, PAYLOAD_TEMPLATE_PASSIN_OneVar );
	}
	template< class UserClass, PAYLOAD_TEMPLATE_DECL_OneVar >
	inline void BindSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename TSPMethodDelegate_OneVar_Const< UserClass, PAYLOAD_TEMPLATE_LIST_OneVar >::FMethodPtr InFunc, PAYLOAD_TEMPLATE_ARGS_OneVar )
	{
		*this = CreateSP( InUserObjectRef, InFunc, PAYLOAD_TEMPLATE_PASSIN_OneVar );
	}
	template< class UserClass, PAYLOAD_TEMPLATE_DECL_TwoVars >
	inline void BindSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename TSPMethodDelegate_TwoVars< UserClass, PAYLOAD_TEMPLATE_LIST_TwoVars >::FMethodPtr InFunc, PAYLOAD_TEMPLATE_ARGS_TwoVars )
	{
		*this = CreateSP( InUserObjectRef, InFunc, PAYLOAD_TEMPLATE_PASSIN_TwoVars );
	}
	template< class UserClass, PAYLOAD_TEMPLATE_DECL_TwoVars >
	inline void BindSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename TSPMethodDelegate_TwoVars_Const< UserClass, PAYLOAD_TEMPLATE_LIST_TwoVars >::FMethodPtr InFunc, PAYLOAD_TEMPLATE_ARGS_TwoVars )
	{
		*this = CreateSP( InUserObjectRef, InFunc, PAYLOAD_TEMPLATE_PASSIN_TwoVars );
	}
	template< class UserClass, PAYLOAD_TEMPLATE_DECL_ThreeVars >
	inline void BindSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename TSPMethodDelegate_ThreeVars< UserClass, PAYLOAD_TEMPLATE_LIST_ThreeVars >::FMethodPtr InFunc, PAYLOAD_TEMPLATE_ARGS_ThreeVars )
	{
		*this = CreateSP( InUserObjectRef, InFunc, PAYLOAD_TEMPLATE_PASSIN_ThreeVars );
	}
	template< class UserClass, PAYLOAD_TEMPLATE_DECL_ThreeVars >
	inline void BindSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename TSPMethodDelegate_ThreeVars_Const< UserClass, PAYLOAD_TEMPLATE_LIST_ThreeVars >::FMethodPtr InFunc, PAYLOAD_TEMPLATE_ARGS_ThreeVars )
	{
		*this = CreateSP( InUserObjectRef, InFunc, PAYLOAD_TEMPLATE_PASSIN_ThreeVars );
	}
	template< class UserClass, PAYLOAD_TEMPLATE_DECL_FourVars >
	inline void BindSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename TSPMethodDelegate_FourVars< UserClass, PAYLOAD_TEMPLATE_LIST_FourVars >::FMethodPtr InFunc, PAYLOAD_TEMPLATE_ARGS_FourVars )
	{
		*this = CreateSP( InUserObjectRef, InFunc, PAYLOAD_TEMPLATE_PASSIN_FourVars );
	}
	template< class UserClass, PAYLOAD_TEMPLATE_DECL_FourVars >
	inline void BindSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename TSPMethodDelegate_FourVars_Const< UserClass, PAYLOAD_TEMPLATE_LIST_FourVars >::FMethodPtr InFunc, PAYLOAD_TEMPLATE_ARGS_FourVars )
	{
		*this = CreateSP( InUserObjectRef, InFunc, PAYLOAD_TEMPLATE_PASSIN_FourVars );
	}
...
public:
	 ...
	 */
	template< class UserClass >
	inline FDelegateHandle AddSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename FDelegate::template TSPMethodDelegate< UserClass >::FMethodPtr InFunc )
	{
		return Add( FDelegate::CreateSP( InUserObjectRef, InFunc ) );
	}
	template< class UserClass >
	inline FDelegateHandle AddSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename FDelegate::template TSPMethodDelegate_Const< UserClass >::FMethodPtr InFunc )
	{
		return Add( FDelegate::CreateSP( InUserObjectRef, InFunc ) );
	}
	template< class UserClass, PAYLOAD_TEMPLATE_DECL_OneVar >
	inline FDelegateHandle AddSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename FDelegate::template TSPMethodDelegate_OneVar< UserClass, PAYLOAD_TEMPLATE_LIST_OneVar >::FMethodPtr InFunc, PAYLOAD_TEMPLATE_ARGS_OneVar )
	{
		return Add( FDelegate::CreateSP( InUserObjectRef, InFunc, PAYLOAD_TEMPLATE_PASSIN_OneVar ) );
	}
	template< class UserClass, PAYLOAD_TEMPLATE_DECL_OneVar >
	inline FDelegateHandle AddSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename FDelegate::template TSPMethodDelegate_OneVar_Const< UserClass, PAYLOAD_TEMPLATE_LIST_OneVar >::FMethodPtr InFunc, PAYLOAD_TEMPLATE_ARGS_OneVar )
	{
		return Add( FDelegate::CreateSP( InUserObjectRef, InFunc, PAYLOAD_TEMPLATE_PASSIN_OneVar ) );
	}
	template< class UserClass, PAYLOAD_TEMPLATE_DECL_TwoVars >
	inline FDelegateHandle AddSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename FDelegate::template TSPMethodDelegate_TwoVars< UserClass, PAYLOAD_TEMPLATE_LIST_TwoVars >::FMethodPtr InFunc, PAYLOAD_TEMPLATE_ARGS_TwoVars )
	{
		return Add( FDelegate::CreateSP( InUserObjectRef, InFunc, PAYLOAD_TEMPLATE_PASSIN_TwoVars ) );
	}
	template< class UserClass, PAYLOAD_TEMPLATE_DECL_TwoVars >
	inline FDelegateHandle AddSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename FDelegate::template TSPMethodDelegate_TwoVars_Const< UserClass, PAYLOAD_TEMPLATE_LIST_TwoVars >::FMethodPtr InFunc, PAYLOAD_TEMPLATE_ARGS_TwoVars )
	{
		return Add( FDelegate::CreateSP( InUserObjectRef, InFunc, PAYLOAD_TEMPLATE_PASSIN_TwoVars ) );
	}
	template< class UserClass, PAYLOAD_TEMPLATE_DECL_ThreeVars >
	inline FDelegateHandle AddSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename FDelegate::template TSPMethodDelegate_ThreeVars< UserClass, PAYLOAD_TEMPLATE_LIST_ThreeVars >::FMethodPtr InFunc, PAYLOAD_TEMPLATE_ARGS_ThreeVars )
	{
		return Add( FDelegate::CreateSP( InUserObjectRef, InFunc, PAYLOAD_TEMPLATE_PASSIN_ThreeVars ) );
	}
	template< class UserClass, PAYLOAD_TEMPLATE_DECL_ThreeVars >
	inline FDelegateHandle AddSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename FDelegate::template TSPMethodDelegate_ThreeVars_Const< UserClass, PAYLOAD_TEMPLATE_LIST_ThreeVars >::FMethodPtr InFunc, PAYLOAD_TEMPLATE_ARGS_ThreeVars )
	{
		return Add( FDelegate::CreateSP( InUserObjectRef, InFunc, PAYLOAD_TEMPLATE_PASSIN_ThreeVars ) );
	}
	template< class UserClass, PAYLOAD_TEMPLATE_DECL_FourVars >
	inline FDelegateHandle AddSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename FDelegate::template TSPMethodDelegate_FourVars< UserClass, PAYLOAD_TEMPLATE_LIST_FourVars >::FMethodPtr InFunc, PAYLOAD_TEMPLATE_ARGS_FourVars )
	{
		return Add( FDelegate::CreateSP( InUserObjectRef, InFunc, PAYLOAD_TEMPLATE_PASSIN_FourVars ) );
	}
	template< class UserClass, PAYLOAD_TEMPLATE_DECL_FourVars >
	inline FDelegateHandle AddSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename FDelegate::template TSPMethodDelegate_FourVars_Const< UserClass, PAYLOAD_TEMPLATE_LIST_FourVars >::FMethodPtr InFunc, PAYLOAD_TEMPLATE_ARGS_FourVars )
	{
		return Add( FDelegate::CreateSP( InUserObjectRef, InFunc, PAYLOAD_TEMPLATE_PASSIN_FourVars ) );
	}
...
public:
	...
	inline void RemoveSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename FDelegate::template TSPMethodDelegate< UserClass >::FMethodPtr InFunc )
	{
	...
	template< class UserClass >
	DELEGATE_DEPRECATED("RemoveSP is deprecated - please remove delegates using the FDelegateHandle returned by the Add function.")
	inline void RemoveSP( const std::shared_ptr< UserClass >& InUserObjectRef, typename FDelegate::template TSPMethodDelegate_Const< UserClass >::FMethodPtr InFunc )
	{
		DEPRECATED_RemoveDelegateInstance( (TDelegateInstanceInterface*)FDelegate::CreateSP( InUserObjectRef, InFunc ).GetDelegateInstance() );
	}
...
protected:
	...
	BASE_MULTICAST_DELEGATE_CLASS& operator=( const BASE_MULTICAST_DELEGATE_CLASS& Other )
	{
		if (&Other != this)
		{
			...
			const std::vector<IDelegateInstance*>& list = Other.GetInvocationList();
			for (auto iter = list.begin(); iter != list.end(); ++iter)
			{
				IDelegateInstance* DelegateInstance = *iter;
				{
					// this down-cast is OK! allows for managing invocation list in the base class without requiring virtual functions
...
protected:
	...
	FDelegateHandle AddDelegateInstance( TDelegateInstanceInterface* InDelegateInstance )
	{
		...
		const std::vector<IDelegateInstance*>& list = GetInvocationList();
		for (auto iter = list.begin(); iter != list.end(); ++iter)
		{
			IDelegateInstance* DelegateInstance = *iter;
			{
	...
	void Broadcast( FUNC_PARAM_LIST ) const
	{
		...
		LockInvocationList();
		{
			const std::vector<IDelegateInstance*>& InvocationList = GetInvocationList();
	...
	void RemoveDelegateInstance( FDelegateHandle Handle )
	{
		...
		for (int32_t InvocationListIndex = 0; InvocationListIndex < InvocationList.size(); ++InvocationListIndex)
		{
			// this down-cast is OK! allows for managing invocation list in the base class without requiring virtual functions
