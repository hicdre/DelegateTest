...
public:
	 ...
	 */
	SP_METHOD_DELEGATE_INSTANCE_CLASS( const std::shared_ptr<UserClass>& InUserObject, FMethodPtr InMethodPtr DELEGATE_COMMA_PAYLOAD_LIST )
...
public:
	...
	{
		return EDelegateInstanceType::ThreadSafeSharedPointerMethod/* : EDelegateInstanceType::SharedPointerMethod*/;
	}
...
public:
	 ...
	 */
	FORCEINLINE static DELEGATE_INSTANCE_INTERFACE_CLASS<FUNC_TEMPLATE_ARGS>* Create( const std::shared_ptr<UserClass>& InUserObjectRef, FMethodPtr InFunc DELEGATE_COMMA_PAYLOAD_LIST )
	{
	 ...
	 * Creates a new shared pointer delegate binding for the given user object and method pointer.
	 *
	 * This overload requires that the supplied object derives from TSharedFromThis. std::enable_shared_from_this
	 *
	...
	FORCEINLINE static DELEGATE_INSTANCE_INTERFACE_CLASS<FUNC_TEMPLATE_ARGS>* Create( UserClass* InUserObject, FMethodPtr InFunc DELEGATE_COMMA_PAYLOAD_LIST )
	{
		...
		std::shared_ptr<UserClass> UserObjectRef(InUserObject->shared_from_this());
...
private:
	...
	template<class UserClassNoShadow, FUNC_PAYLOAD_TEMPLATE_DECL_NO_SHADOW> friend class SP_METHOD_DELEGATE_INSTANCE_CLASS;
